...
local Window = Fluent:CreateWindow({
    Title = "Nexus hub",
    SubTitle = "- join my discord server : https://discord.com/invite/TgNPc98j",
    TabWidth = 145,
...
local Tabs = {
    Main = Window:AddTab({ Title = "Main", Icon = "nexus" }),
    Stats = Window:AddTab({ Title = "Sub", Icon = "nexus" }),
    Info = Window:AddTab({ Title = "Status", Icon = "nexus" }),
    Seaev = Window:AddTab({ Title = "Sea Event", Icon = "nexus" }),
    Player = Window:AddTab({ Title = "Player", Icon = "nexus" }),
    Teleport = Window:AddTab({ Title = "Teleport", Icon = "nexus" }),
    Fruit = Window:AddTab({ Title = "Blox Fruits", Icon = "nexus" }),
    Raid = Window:AddTab({ Title = "Raids", Icon = "nexus" }),
    Race = Window:AddTab({ Title = "Race Trial", Icon = "nexus" }),
    Shop = Window:AddTab({ Title = "Shop", Icon = "nexus" }),
    Misc = Window:AddTab({ Title = "Misc", Icon = "nexus" }),
    Hop = Window:AddTab({ Title = "Server", Icon = "nexus" }),
    Setting = Window:AddTab({ Title = "Settings", Icon = "nexus" }),
    Fluent = Window:AddTab({ Title = "Config", Icon = "nexus" }),
}
...
if id == 2753915549 then First_Sea = true; elseif id == 4442272183 then Second_Sea = true; elseif id == 7449423635 then Third_Sea = true; else game.Players.LocalPlayer:Kick("Check script here : https://discord.com/invite/TgNPc98j") end;
-- anti
function AntiBan()
...
print("made by mun")
    print("Nexus hub")
    print("join my discord server : https://discord.com/invite/TgNPc98j")
    print("script free")
    print("ty for using")
    print("sk (on discord : @nexusisbest)")
    print("wait ,.,")
    print("LCTSV - .,.")  
...
L_92_.Image = "rbxassetid://811085213"
...
--]]-- fluent
InterfaceManager:SetFolder("nexus_HUB")
SaveManager:SetFolder("nexus_HUB")
