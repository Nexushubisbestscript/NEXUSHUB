...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>sau rất lâu làm để làm<Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Thì NEXUS HUB đã suất hiện<Color=/>"):Display()
    wait(.14)
    ...
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>cày thuê ib discord nexusisbest <Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "NEXUS HUB", HidePremium = false, IntroText = "NEXUS HUB", SaveConfig = true, ConfigFolder = "NEXUS HUB"})
...
W:AddLabel("Script By MUBDEPZAI")

local Section = W:AddSection({
    Name = "Update"
})

W:AddLabel("[+] NEXUS HUB new script!")
W:AddLabel("[+] script is vip!")
W:AddLabel("[+] I like this script")
